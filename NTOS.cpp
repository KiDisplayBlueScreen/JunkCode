// NTOS.cpp : Defines the entry point for the console application.
//
...
NTSTATUS DriverEntry(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
	...
	Status = IoCreateDevice(DriverObject, 0, &DeviceNameUnicodeString, 0x00001234, 0, TRUE, &G_RootkitDevice);
}
